...
import { PaydunyaSettingsForm } from "@/components/admin/PaydunyaSettingsForm";
...
export default async function AdminSettingsPage() {
  ...
  const [{ data: rows }, paydunyaConfig] = await Promise.all([
    supabase
      .from("site_settings")
      .select("key, value")
  ...
  return (
    <div className="animate-fade-up">
      ...
      <div className="space-y-6">
        ...
        />
        <PaydunyaSettingsForm initial={paydunyaConfig} />
      </div>
    </div>
  );
}
