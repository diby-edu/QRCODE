...
const NAV_ITEMS = [
  ...
  { key: "traffic", href: "/admin/traffic", exact: false },
  { key: "domains", href: "/admin/domains", exact: false },
  { key: "activity", href: "/admin/activity", exact: false },
...
const NAV_ICONS: Record<(typeof NAV_ITEMS)[number]["key"], React.ReactNode> = {
  ...
  activity: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="h-5 w-5" aria-hidden>
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 7.5V6.108c0-1.135.845-2.098 1.976-2.192.373-.03.748-.057 1.123-.08M15.75 18H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08M15.75 18.75v-1.875a3.375 3.375 0 0 0-3.375-3.375h-1.5a1.125 1.125 0 0 1-1.125-1.125v-1.5A3.375 3.375 0 0 0 6.375 7.5H5.25m11.9-3.664A2.251 2.251 0 0 0 15 2.25h-1.5a2.251 2.251 0 0 0-2.15 1.586m5.8 0c.065.21.1.433.1.664v.75h-6V4.5c0-.231.035-.454.1-.664M6.75 7.5h1.5v1.5h-1.5V7.5Zm0 3h1.5v1.5h-1.5V10.5Zm0 3h1.5v1.5h-1.5V13.5Z" />
    </svg>
  ),
};
